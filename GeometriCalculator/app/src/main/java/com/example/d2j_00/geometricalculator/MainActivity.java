package com.example.d2j_00.geometricalculator;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void calculate(View view){
        ...
        if(input2.isEnabled()){
            inp2 = Double.parseDouble(input1.getText().toString());
        }
        if(operator.equalsIgnoreCase("lingkaran")){
            hasil = "luas dari lingkaran adalah"+(Math.PI * (inp1*inp1))+"\n";
            hasil += "keliling dari linkaran adalah: "+(Math.PI*(2*inp1));
            ...
            hasil += "keliling dari persegi adalah: "+(2*(inp1+inp2));
        }
